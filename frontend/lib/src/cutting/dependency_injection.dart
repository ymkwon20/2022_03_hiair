...
import 'package:frontend/src/cutting/application/cutting_check_state_notifier.dart';
import 'package:frontend/src/cutting/application/cutting_request_state.dart';
import 'package:frontend/src/cutting/application/cutting_request_state_notifier.dart';
import 'package:frontend/src/cutting/application/cutting_serial_state.dart';
import 'package:frontend/src/cutting/application/cutting_serial_state_notifier.dart';
...
final cuttingRemoteServiceProvider = Provider<CuttingService>(
  (ref) => CuttingRemoteService(dio: ref.watch(dioProvider)),
);
