...
import 'package:frontend/src/fec/presentation/screens/fec_popup.dart';
...
import 'tablerows/fec_loaded_row.dart';

class FECScreen extends ConsumerStatefulWidget {
  const FECScreen({
    Key? key,
  ...
  @override
  ConsumerState<FECScreen> createState() => _FECWidgetState();
}

class _FECWidgetState extends ConsumerState<FECScreen>
