...
class ImpellerFinishButtons extends ConsumerStatefulWidget {
  const ImpellerFinishButtons({
    Key? key,
  ...
  @override
  ConsumerState<ImpellerFinishButtons> createState() =>
      _ImpellerStartEndButtonsState();
}

class _ImpellerStartEndButtonsState extends ConsumerState<ImpellerFinishButtons>
