...
class FP4Screen extends ConsumerStatefulWidget {
  const FP4Screen({
    Key? key,
  ...
  @override
  ConsumerState<FP4Screen> createState() => _FP4WidgetState();
}

class _FP4WidgetState extends ConsumerState<FP4Screen>
            ...
            child: CustomTable(
              ...
              headers: [
                ...
                CustomTableHeader(
                  ...
                  children: _buildAdditionalIcons("weight"),
                ),
              ],
