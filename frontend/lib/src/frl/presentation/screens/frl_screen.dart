...
import 'package:frontend/src/frl/presentation/screens/frl_popup.dart';
import 'package:frontend/src/frl/presentation/screens/tablerows/frl_loaded_row.dart';
...
class FRLScreen extends ConsumerStatefulWidget {
  const FRLScreen({
    Key? key,
  ...
  @override
  ConsumerState<FRLScreen> createState() => _FRLWidgetState();
}

class _FRLWidgetState extends ConsumerState<FRLScreen>
