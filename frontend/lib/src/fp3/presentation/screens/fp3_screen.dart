...
import 'package:frontend/src/fp3/presentation/screens/fp3_popup.dart';
import 'package:frontend/src/fp3/presentation/screens/tablerows/fp3_loaded_row.dart';
...
class FP3Screen extends ConsumerStatefulWidget {
  const FP3Screen({
    Key? key,
  ...
  @override
  ConsumerState<FP3Screen> createState() => _FP3WidgetState();
}

class _FP3WidgetState extends ConsumerState<FP3Screen>
            ...
            child: CustomTable(
              ...
              headers: [
                ...
                CustomTableHeader(
                  ...
                  children: _buildAdditionalIcons("inside"),
                ),
                CustomTableHeader(
                  name: "inDomar",
                  title: "IN도막",
                  ...
                  children: _buildAdditionalIcons("inDomar"),
                ),
                CustomTableHeader(
                  name: "outside",
                  title: "OUSIDE",
                  ...
                  children: _buildAdditionalIcons("outside"),
                ),
                CustomTableHeader(
                  name: "outDomar",
                  title: "OUT도막",
                ...
                CustomTableHeader(
                  ...
                  onTap: ref.read(workOrderListNotifier.notifier).sort,
                  onLongTap: () {
                    _navigateTo("material");
                  },
                  children: _buildAdditionalIcons("material"),
                ),
                CustomTableHeader(
                  name: "befCloseDT",
                  title: "전공정실적일",
