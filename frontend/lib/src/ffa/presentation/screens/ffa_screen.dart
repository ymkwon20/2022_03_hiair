...
import 'package:frontend/src/ffa/presentation/screens/ffa_popup.dart';
...
import 'tablerows/ffa_loaded_row.dart';

class FFAScreen extends ConsumerStatefulWidget {
  const FFAScreen({
    Key? key,
  ...
  @override
  ConsumerState<FFAScreen> createState() => _FFAWidgetState();
}

class _FFAWidgetState extends ConsumerState<FFAScreen>
            ...
            child: CustomTable(
              ...
              headers: [
                CustomTableHeader(
                  ...
                  onLongTap: () {
                    _navigateTo("chkTblDT");
                  },
                  children: _buildAdditionalIcons("chkTblDT"),
                ),
                CustomTableHeader(
                  name: "yard",
                  title: "Yard",
