...
import 'package:frontend/src/fp2/presentation/screens/fp2_popup.dart';
...
import 'tablerows/fp2_loaded_row.dart';

class FP2Screen extends ConsumerStatefulWidget {
  const FP2Screen({
    Key? key,
  ...
  @override
  ConsumerState<FP2Screen> createState() => _FP2WidgetState();
}

class _FP2WidgetState extends ConsumerState<FP2Screen>
