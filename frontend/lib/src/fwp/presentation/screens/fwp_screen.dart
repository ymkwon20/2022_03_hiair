...
import 'package:frontend/src/fwp/presentation/screens/fwp_popup.dart';
...
import 'tablerows/fwp_loaded_row.dart';

class FWPScreen extends ConsumerStatefulWidget {
  const FWPScreen({
    Key? key,
  ...
  @override
  ConsumerState<FWPScreen> createState() => _FWPWidgetState();
}

class _FWPWidgetState extends ConsumerState<FWPScreen>
            ...
            child: CustomTable(
              ...
              headers: [
                ...
                CustomTableHeader(
                  ...
                  children: _buildAdditionalIcons("frame"),
                ),
                CustomTableHeader(
                  name: "wonb",
                  title: "작업지시번호",
