...
import 'package:frontend/src/fel/presentation/screens/fel_popup.dart';
import 'package:frontend/src/fel/presentation/screens/tablerows/fel_loaded_row.dart';
...
class FELScreen extends ConsumerStatefulWidget {
  const FELScreen({
    Key? key,
  ...
  @override
  ConsumerState<FELScreen> createState() => _FELWidgetState();
}

class _FELWidgetState extends ConsumerState<FELScreen>
